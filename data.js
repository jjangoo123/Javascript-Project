...
const qnaList = [
  {
    ...
    a: [
      ...
      { answer: 'b. 친구 있지, 절대 이성으로만 안 보일뿐', type: ['0', 'rabbit', '6', '5', '10', '8'] },
  ...
  },
  {
    ...
    a: [
      { answer: 'a. 바로 먼저 연락한다.', type: ['0', 'rabbit', '2', '8'] },
  ...
  },
  {
    q: '3. 당신의 고백 스타일은?',
    a: [
      { answer: 'a. 호감이 보이면 바로 고백한다', type: ['1', 'rabbit', '2', '10', '8'] },
  ...
  },
  {
    ...
    a: [
      ...
      { answer: 'c. 센스있는 "우리 내일은 연인으로 만날까요" ', type: ['0', 'rabbit', '6', '5' ] },
    ]
  },
  {
    ...
    a: [
      ...
      { answer: 'b. 요즘 시대가 어느 때인데, 가벼운 뽀뽀까지 가능이야', type: ['0', 'rabbit', '6', '11']},
...

  {
    ...
    a: [
      ...
      { answer: 'b. 맛있는 밥이나 사줄까? 아니면 꽃이라도?', type: ['0', 'rabbit', '6', '10' ] },
  ...
  },
  {
    ...
    a: [
      ...
      { answer: 'c. "오 대박 오늘 머리도 바꾸고 옷도 새로 샀네?"라고 하며 단번에 눈치챈다', type: ['0', 'rabbit', '6', '5', '10', '8' ] },
    ]
  },
  {
    ...
    a: [
      ...
      { answer: 'b. 연인이 살고 있는 집의 역이나 정류장까지 데려다준다.', type: ['rabbit', '2', '6', '5', '10', '8' ] },
  ...
  },
  {
    ...
    a: [
      ...
      { answer: 'b. 초조해서 마음 졸이며 인스타, 페북, 카톡 등 모든 SNS 다 들어가본다.', type: ['1', 'rabbit', '6', '11' ] },
  ...
  },
  {
    ...
    a: [
      ...
      { answer: 'c. 헐 대박, 어디야?? 당장 나갈게!', type: ['1', '7', 'rabbit', '10', '8' ] },
    ]
  },
  {
    q: '11. 내가 추구하는 연애관은? ',
    a: [
      ...
      { answer: 'b. 보고싶을 때 보고, 데이트도 많이 하고 꽁냥꽁냥하는 연애가 좋아.', type: ['7', '0', 'rabbit', '6', '10'] },
  ...
  },
  {
    ...
    a: [
      { answer: 'a. "아 화나네. 따라오지마 오늘 집 갈 거니까." 라고 말하며 집으로 간다.', type: ['rabbit', '6', '4', '9' ] },
